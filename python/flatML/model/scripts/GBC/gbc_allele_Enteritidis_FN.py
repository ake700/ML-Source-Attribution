                    ...
                    for filter_threshold in config['setup']['filter_threshold']:
                        ...
                        for y_col in config['setup']['y_col']:
                            ...
                            if 'Enteritidis' == 'All':
                                ...
                                filtered_df = allele[allele['Serovar'] == 'Enteritidis']

                            results_dict = gbc_allele(filtered_df, 'Serovar', 'Enteritidis', test_size, db='default', y_col=y_col, dataType='allele', method=sampling_strat, filter_threshold=filter_threshold, feat_eng=feat_eng, feat_elim_method=feat_elim_method)
