                    ...
                    for filter_threshold in config['setup']['filter_threshold']:
                        ...
                        for y_col in config['setup']['y_col']:
                            ...
                            if 'Typhimurium' == 'All':
                                ...
                                filtered_df = allele[allele['Serovar'] == 'Typhimurium']

                            results_dict = svm_allele(filtered_df, 'Serovar', 'Typhimurium', test_size, db='default', y_col=y_col, dataType='allele', method=sampling_strat, filter_threshold=filter_threshold, feat_eng=feat_eng, feat_elim_method=feat_elim_method)
