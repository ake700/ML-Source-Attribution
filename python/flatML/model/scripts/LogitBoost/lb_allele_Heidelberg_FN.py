...
# Suppress all user/future warnings for LogitBoost
...
results_path = config['setup']['models']['Logit_Boost']['results_path']

# Set variables for dictionary
seed = config['setup']['seed'][0]
filter_prov = config['setup']['variables']['filter_prov']
model_type = config['setup']['models']['Logit_Boost']['model_type']
            ...
            for sampling_strat in config['setup']['sampling_strategy']:
                ...
                for filter_threshold in config['setup']['filter_threshold']:
                    ...
                    for y_col in config['setup']['y_col']:
                        ...
                        results_dict = lb_allele(filtered_df, 'Serovar', 'Heidelberg', test_size, db='default', y_col=y_col, dataType='allele', method=sampling_strat, filter_threshold=filter_threshold, feat_eng=feat_eng)
